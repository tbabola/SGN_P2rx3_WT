function [h, p] = compare4_jitter(group1, group2, group3, group4, conditions, ylbl, dim, markSz, color1, color2)
       ...
       scatter(1*ones(m,1), group1,markSize,l_grey,'filled','jitter','on'); hold on;
       scatter(2*ones(m2,1), group2,markSize,l_grey,'filled','jitter','on');
       scatter(3*ones(m3,1), group3,markSize,l_grey,'filled','jitter','on');
       scatter(4*ones(m4,1), group4,markSize,l_grey,'filled','jitter','on');
